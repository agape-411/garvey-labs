    ...
    <main className='font-inter text-[#1B3A5C] bg-white'>
      ...
      <section className='relative w-full bg-[#0f2438] text-white'>
        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24 md:py-32 text-center'>
          <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold leading-tight max-w-3xl mx-auto'>
            Strategic Advisory Services
          </h1>
          <p className='mt-4 sm:mt-6 text-base sm:text-lg md:text-xl lg:text-2xl font-light text-gray-200 max-w-2xl mx-auto px-2'>
            From first intelligence to enforceable agreement — a defined
            six-tier service ladder, community-side only.
          </p>
          <p className='mt-3 sm:mt-4 text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 max-w-3xl mx-auto px-2'>
            No pricing on this page. Each tier ends with a CTA to Contact Us.
            Pricing is discussed in the initial conversation.
          </p>
        </div>
      </section>
      ...
      <section className='max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-24'>
        ...
        <p className='text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl'>
          Garvey Labs is a productized advisory firm built on rigorous
          analytical backing. Every service tier has a defined scope, a
          population-based price, and a documented delivery timeline — before
          you sign. The service ladder is sequential: each tier creates pull
          toward the next through fee credits, conversion mechanics, and
          deliberately structured deliverables that name the scope of the
      ...
      {/* ================= SERVICE LADDER ================= */}
      <section className='max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-24'>
        <h2 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mb-8 sm:mb-12 md:mb-16'>
          The Service Ladder
        </h2>
...
function ServiceTier({
  ...
  return (
    <div className='border-l-4 border-[#B8860B] pl-4 sm:pl-6'>
      ...
      <Link
        href={ctaLink}
        className='inline-block text-[#1B3A5C] font-semibold hover:underline transition-colors'
      >
        {ctaText}
      </Link>
    </div>
