    ...
    <main className='bg-white text-[#1B3A5C] font-inter'>
      ...
      <section className='relative w-full bg-[#0f2438] text-white'>
        ...
        <div className='relative max-w-7xl mx-auto px-6 py-32'>
          ...
          <p className='mt-6 text-base sm:text-lg md:text-xl font-light text-gray-200 max-w-2xl'>
            Helping communities capture value from data center investment before
            developers define the terms.
          </p>
        </div>
      </section>
      ...
      <section className='max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16'>
        ...
        <div>
          ...
          <p className='text-base md:text-lg leading-relaxed mb-6'>
            Data center developers spent a decade building in white suburban
            communities — Northern Virginia, suburban Atlanta, suburban Phoenix.
            Those communities are now producing organized opposition,
            litigation, and moratorium legislation at the local, state, and
            federal level. The traditional siting model is under structural
            strain.
          </p>

          <p className='text-base md:text-lg leading-relaxed mb-6'>
            At the same time, a different class of communities has remained
            structurally under-targeted: majority-Black communities with
            industrial land, transmission adjacency, fiscal motivation, and
            economic development institutions capable of supporting serious
            agreements. These communities have been overlooked not because they
            lack the prerequisites — but because they have lacked the framework.
          </p>

          <p className='text-base md:text-lg leading-relaxed'>
            The next three years are the most important siting years of the data
            center economy. Garvey Labs helps communities use that window to
            negotiate maximum community benefit before potential political or
            regulatory shifts.
          </p>
        </div>
        ...
        <div className='grid grid-cols-2 gap-6'>
          {[
            {
              value: '20+',
              label: 'projects canceled or delayed due to opposition in 2025',
            },
            {
              value: '11+',
              label: 'states with active moratorium or restriction legislation',
            },
            {
              value: '$4M+',
              label: 'per home offered in Ashburn, VA (March 2026)',
            },
            {
              value: '$250M–$900M+',
              label: 'advantage of a prepared community vs. suburban markets',
            },
          ].map((stat, i) => (
            <div key={i} className='border-l-4 border-[#B8860B] pl-4'>
              <p className='text-2xl sm:text-3xl md:text-4xl font-semibold text-[#0D6E6E]'>
                {stat.value}
              </p>
              <p className='text-xs sm:text-sm md:text-sm mt-2 text-gray-600 leading-snug'>
                {stat.label}
              </p>
            </div>
          ))}
      ...
      <section className='bg-gray-50 py-24'>
        <div className='max-w-7xl mx-auto px-6'>
          ...
          <h2 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mb-16 max-w-3xl'>
          ...
          <div className='mt-20 max-w-4xl border-t pt-10'>
            <p className='text-base md:text-lg text-gray-700 leading-relaxed'>
              All Garvey Labs analysis is built on rigorous analytical backing:
              verifiable data, unbiased conclusions, and documented, citable
              sources. This is the standard that makes Garvey Labs work credible
              in developer negotiations, public hearings, and stakeholder
              environments.
            </p>
      ...
      <section className='bg-gray-50 py-24'>
        <div className='max-w-7xl mx-auto px-6'>
          <h2 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mb-16'>
            Related Services
          </h2>
  ...
  return (
    <Link href={link} className='group block'>
      ...
      <div className='bg-white p-6 border border-gray-200'>
        ...
        <h3 className='text-lg sm:text-xl md:text-2xl font-semibold mb-3 leading-snug'>
          {title}
        </h3>
